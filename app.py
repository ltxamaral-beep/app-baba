...
# Configuração da Página com modo responsivo otimizado para celulares
st.set_page_config(
...
# Design System & CSS Otimizado para Mobile e Desktop
st.markdown("""
    <style>
        .stApp {
...
# Abas Principais (Compactas para Mobile)
...
# ==========================================
# ABA 1: RODADA DE DOMINGO (Presença & Sorteio)
# ==========================================
with tab1:
    st.title("⚽ Gestão da Rodada")
    st.markdown("Confirme a **Lista de Presença** e gere o sorteio equilibrado dos 4 times.")
    st.divider()
    ...
    st.subheader("✅ Lista de Chamada")
    st.markdown("Marque quem confirmou presença:")
...
# ==========================================
# ABA 2: CLASSIFICAÇÃO & RANKING ANUAL
# ==========================================
with tab2:
    st.title("🏆 Ranking & Estatísticas")
    st.markdown("Classificação e artilharia acumulada da temporada.")
    st.divider()
    ...
    try:
        ...
        st.subheader("🛡️ Clean Sheets (Goleiros)")
...
# ==========================================
# ABA 3: SORTEIO DE APOIO
# ==========================================
with tab3:
    st.title("🎲 Sorteio de Apoio")
    st.markdown("Ferramenta auxiliar. A lista oficial de chamada fica na **Aba 1**.")
...
with tab4:
    ...
    st.markdown("Resumo de receitas, custos, multas e inadimplência.")
    st.divider()
