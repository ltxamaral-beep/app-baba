...
with tab1:
    ...
    try:
        df_atletas, df_partidas, df_eventos = carregar_dados_esporte()
        ...
        st.error(f"Erro ao carregar dados esportivos: {e}")
...
with tab2:
    ...
    st.markdown("Ferramenta para divisão de 4 times baseada nas posições e níveis dos atletas.")
    
    # Lista de atletas confirmados (pode ser ajustada)
...
with tab3:
    ...
    def carregar_dados_financeiros():
        ...
        return df_fluxo, df_mensalidades

    try:
        df_fluxo, df_mensalidades = carregar_dados_financeiros()
        ...
        # Agrupar mensalidades por associado para ver quem está em dia ou pendente
